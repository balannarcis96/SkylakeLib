...
#pragma once
    ...
    #define SKL_MALLOC_ALIGNED( InSize, InAlignemnt ) _aligned_malloc( InSize, InAlignemnt )

    #define SKL_FREE( InPtr ) free( InPtr )
    #define SKL_FREE_ALIGNED( InPtr, InAlignemnt ) _aligned_free( InPtr )
    #define SKL_FREE_SIZE_ALIGNED( InPtr, InSize, InAlignemnt ) _aligned_free( InPtr )
#endif
